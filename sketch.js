var splash
var gameState = "wait"
var playbutton, playerimg, invisibleground, soundonbutton, soundoffbutton, level1bgimg, level1bg, level2bgimg, level2bg
var health = 0
var maxHealth = 400
var playerimg1
var score1 = 0
...
function preload() {
    ...
    // enemy Images
   enemy1img = loadImage("assets/enemy/enemy1.png") 
   enemy2img = loadImage("assets/enemy/enemy2.png")
   enemy3img = loadImage("assets/enemy/enemy3.png")
}
...
function setup() {
    ...
    playbutton.position(width / 2 - 100, height / 2.5 + height / 4)
    ...
    level1bg = createSprite(width / 2, height / 1.4, width, height)
...
if (frameCount % 100 ===0){
    var enemy= createSprite(width,height-200)
    enemy.velocityX=-6
